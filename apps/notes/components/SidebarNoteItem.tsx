...
const SidebarNoteItem: React.FC<SidebarNoteItemProps & Note> = ({ id, title, content, updateTime }) => {
  return (
    <SidebarNoteItemContent
      id={id}
      expandedChildren={<p style={{ fontSize: 14, color: '#404040' }}>{content.slice(0, 20) || 'No content'}</p>}
    >
